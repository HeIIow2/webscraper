...
def draw_diagram(label_class, magazine, dates_, values, dump_path: str, dump_path_slopes: str, added_days=7,
                 number_of_communities=5, x_label_tilt=45):
    """
    ...
    for community in values:
        color = next(ax._get_lines.prop_cycler)['color']
        plt.plot(dates_slopes, slopes[community], '-', color=color,
                 label=get_label(community, slopes[community], label_class))
